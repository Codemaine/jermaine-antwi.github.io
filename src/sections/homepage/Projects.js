  ...
  return (
    <main className="py-16 md:py-32 min-[1200px]:py-36 px-0 w-full md:px-20 flex flex-col gap-12">
        <div className='px-8 min-[1200px]:px-0'>
          <p className={`${headingFont.className} text-[56px] border-t-2 pt-3 border-t-black`}>Work</p>
        </div>
        <div className="flex flex-col gap-5">
          <Image className="aspect-[244/153] w-full rounded-none md:rounded-2xl" alt={`${projects_array[0].name.toLowerCase()}-image`} width={244} height={153} src={projects_array[0].image} />
          <div className='px-8 min-[1200px]:px-0'>
        ...
        <div className="flex flex-col md:flex-row w-full gap-12">
          {projects_array.slice(1,3).map((item) => (<div className="flex flex-col gap-5 w-full">
            <Image className="aspect-[244/153] w-full rounded-none md:rounded-2xl" width={244} height={153} src={item.image} alt={`${item.name.toLowerCase()}-image`} />
            <div className='px-8 min-[1200px]:px-0'>
